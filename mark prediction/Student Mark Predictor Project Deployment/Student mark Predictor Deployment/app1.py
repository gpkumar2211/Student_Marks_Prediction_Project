...
app = Flask(__name__)
model = joblib.load(r"D:\Full Stack Data Science AI & ML\ClassNotes\mark prediction\Student Mark Predictor Project Deployment\Student mark Predictor Deployment\student_mark_predictor1.pkl")
